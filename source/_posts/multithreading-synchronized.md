...
## 第二条
当一个线程访问"某对象"的synchronized方法或"synchronized代码块"时，其他线程仍可以访问"该对象"的非同步代码块。
下面是“synchronized代码块”对应的演示程序。
```
class Count {
...
## 第三条
当一个线程访问"某对象的"synchronized方法或者"synchronized代码块"时，其他线程对"该对象"的其他synchronized方法或"synchronized代码块"的访问将被阻塞。
